...
// Configuration object for centralized (Sonar) API settings: url, api key, headers and model settings
object ApiConfig {
    // Base URL for Perplexity API
    const val BASE_URL = "https://api.perplexity.ai/"
    // Retrieve the API key from BuildConfig (generated by Secrets Gradle Plugin) using the 'get()' property
    val API_KEY: String
